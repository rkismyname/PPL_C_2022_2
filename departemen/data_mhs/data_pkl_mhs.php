...
$query = "SELECT * FROM mahasiswa INNER JOIN pkl ON mahasiswa.pkl_id = pkl.pkl_id " ;
    ...
    <div class="isi">
        <div class="bgdosen isi-bgmhs">
            ...
            <div class="judul-isi-data">
                Data PKL Mahasiswa Informatika UNDIP
            </div>
            <div class="isi-data-mhs">
                <table>
                    ...
                    <?php
                        $query = "SELECT user.username, departemen.*, mahasiswa.*, pkl.* FROM user JOIN departemen ON user.username = departemen.username JOIN mahasiswa JOIN pkl ON pkl.pkl_id = mahasiswa.pkl_id WHERE user.username = '$username'";
