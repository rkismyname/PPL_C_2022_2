    ...
    <div class="isi">
        <div class="bgdosen isi-bgmhs">
            ...
            <div class="judul-isi-data">
                Data SKRIPSI Mahasiswa Informatika UNDIP
            </div>
            <div class="isi-data-mhs">
                <table>
                    <tr>
                        ...
                        <th>Nilai Skripsi</th>
                        <th>Tanggal Lulus Skripsi</th>
                        <th>Lama Studi</th>
                    </tr>
                    <?php
                        $query = "SELECT user.username, departemen.*, mahasiswa.*, skripsi.* FROM user JOIN departemen ON user.username = departemen.username JOIN mahasiswa JOIN skripsi ON skripsi.skripsi_id = mahasiswa.skripsi_id WHERE user.username = '$username'";
